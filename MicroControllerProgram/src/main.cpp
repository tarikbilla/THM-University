// *** Libraries *** (comment out as needed for task)
// ******************************
// *** Task 1 – "Hello World" ***
#include <Arduino.h>
#include <heltec.h>
...
const char* password = "wzAeePb7XfKK564tM6pp"; // put in WIFI password
// ******************************

// ******************************
// *** Task 3 – "Connect MQTT Broker" ***
MqttClient mqttClient(wifiClient);
const char broker[] = "mqtt.ei.thm.de";
int port = 1993;
const char topic[]  = "THM/IoTLab/tarik/BME680";
// ******************************
...
void loop() {
  ...
  // ******************************
  // *** Task 2 – "Connect to local wifi" ***
  while (WiFi.status() != WL_CONNECTED || WiFi.localIP() == IPAddress(10,195,8,5)) {
    WiFi.reconnect();
    delay(5000);
    // *** Task 3 – "Connect MQTT Broker" ***
